...
public class MapDialog extends DialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AtomicReference<GeoPoint> finalLocation = new AtomicReference<>();
        ...
        Button okBtn = binding.dMapBtnOk;
        Button cancelBtn = binding.dMapBtnCancel;
        ...
        okBtn.setOnClickListener(v->{
            listener.onDialogResult(mapViewModel.getLocationName(), finalLocation.get());
            this.dismiss();
        });
